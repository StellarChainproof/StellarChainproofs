...
export const RULES: RuleMeta[] = [
  {
    id: "CP-4337-AA001_HASH_BINDING",
    title: "Incomplete ERC-4337 UserOperation hash binding",
    severity: "high",
    category: "security",
    description: "Detects security-critical UserOperation fields that are not visibly included in the signed operation hash.",
  },
  {
    id: "CP-4337-AA002_ENTRYPOINT_DOMAIN",
    title: "ERC-4337 replay domain weakness",
    severity: "high",
    category: "security",
    description: "Detects missing chain-ID or canonical EntryPoint binding in account-abstraction operation domains.",
  },
  {
    id: "CP-4337-AA003_NONCE_REPLAY",
    title: "ERC-4337 nonce replay risk",
    severity: "high",
    category: "security",
    description: "Detects UserOperation execution paths without recognizable nonce validation or consumption.",
  },
  {
    id: "CP-4337-AA005_AGGREGATOR_SIGNATURE",
    title: "Unsafe ERC-4337 signature aggregation",
    severity: "high",
    category: "security",
    description: "Detects aggregate signature validation that is not visibly associated with the exact operation set.",
  },
  {
    id: "CP-4337-AA006_PAYMASTER_LIMIT",
    title: "Unbounded ERC-4337 paymaster sponsorship",
    severity: "high",
    category: "security",
    description: "Detects paymaster sponsorship paths without recognizable gas or budget limits.",
  },
  {
    id: "CP-4337-AA007_PAYMASTER_DEPOSIT",
    title: "Unsafe ERC-4337 deposit accounting",
    severity: "high",
    category: "security",
    description: "Detects paymaster or EntryPoint deposit accounting without clear authorization or cost settlement.",
  },
  {
    id: "CP-4337-AA008_PAYMASTER_POSTOP",
    title: "Unsafe ERC-4337 paymaster postOp",
    severity: "high",
    category: "security",
    description: "Detects context-sensitive external work in paymaster post-operation handling.",
  },
  {
    id: "CP-4337-AA010_FACTORY_INIT",
    title: "Unsafe counterfactual account initialization",
    severity: "high",
    category: "security",
    description: "Detects factory initialization surfaces without recognizable one-time or trusted-caller authorization.",
  },
  {
    id: "CP-4337-AA012_MODULE_AUTH",
    title: "Unauthorized smart-account module surface",
    severity: "high",
    category: "security",
    description: "Detects module capabilities without a recognizable authorization boundary.",
  },
  {
    id: "CP-4337-AA013_SESSION_KEY",
    title: "Unbounded smart-account session key",
    severity: "high",
    category: "security",
    description: "Detects session-key surfaces without recognizable expiry, nonce, or revocation controls.",
  },
  {
    id: "CP-107",
    swcId: "SWC-107",
